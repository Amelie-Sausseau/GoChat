            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="row mb-3">
                            <label for="old-password" class="col-md-4 col-form-label text-md-end">{{ __('Mot de passe actuel') }}</label>

                            <div class="col-md-6">
                                <input id="old-password" type="password" class="form-control @error('password') is-invalid @enderror" name="current_password" required autocomplete="old-password">
